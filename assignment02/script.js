...
fetch("https://openapi.programming-hero.com/api/videos/categories")
  ...
  .then((doc) => {
    doc.data.forEach((element) => {
      ...
      categoryDiv.innerHTML = `<div class="bg-rose-600 w-20 mt-4 py-2 text-center text-slate-50 rounded">
            ${element.category}
        </div>`;
  ...
  fetch(`https://openapi.programming-hero.com/api/videos/category/${id}`)
    ...
    .then((doc) => {
      ...
      doc.data.forEach((element) => {
        ...
        videoDiv.innerHTML = `<img src="${
          element.thumbnail
        }" alt="thumbnail" style="width:312px; height:200px; display:block">
                <div class="video-data flex gap-2 mt-3">
                    <img src="${
                      element.authors[0].profile_picture
                    }" alt="pfp" style="width:40px; height:40px; border-radius:50%;">
                    <div class="video-texts">
                        ...
                        ${
                          element.others.posted_date != ""
                            ? `<small class="block">
                        ${
                          msToTime(parseInt(element.others.posted_date))[0] != 0
                            ? msToTime(
                        ...
                        ${
                          msToTime(parseInt(element.others.posted_date))[1] != 0
                            ? msToTime(
                                parseInt(element.others.posted_date)
                              )[0] + " minutes "
                            : ""
                        ...
                        ${
                          msToTime(parseInt(element.others.posted_date))[2] != 0
                            ? msToTime(
                                parseInt(element.others.posted_date)
                              )[2] + " seconds "
                            : ""
      ...
      element.thumbnail
            ...
            <div class="video-data flex gap-2 mt-3">
                ...
                <div class="video-texts">
                    ...
                    ${
                      msToTime(parseInt(element.others.posted_date))[0] != 0
                        ? msToTime(parseInt(element.others.posted_date))[0] +
                          " hours "
                        : ""
                    }
                    ${
                    ...
                    ${
                      msToTime(parseInt(element.others.posted_date))[2] != 0
                        ? msToTime(parseInt(element.others.posted_date))[2] +
                          " seconds "
                        : ""
                    }
                    ago
